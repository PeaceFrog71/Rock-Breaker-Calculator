...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    fixed: [
      ...
      'Ship Library drawer now extends full height of the screen',
    ],
  },
...

  {
    ...
    fixed: [
      ...
      'Corrected OptiMax gadget stats: replaced incorrect instability modifier with correct charge window modifier',
    ],
  },
...

  {
    ...
    improved: [
      ...
      'Saving a starter ship clears the name field and prompts for a new name — starter names are reserved',
