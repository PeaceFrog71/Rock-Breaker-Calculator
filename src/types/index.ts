...
export interface LaserHead {
  ...
  optimalDistanceMin?: number; // Minimum optimal mining distance in meters
...
export const LASER_HEADS: LaserHead[] = [
  ...
  { id: 'pitman', name: 'Pitman', maxPower: 3150, resistModifier: 1.25, size: 0, moduleSlots: 2, instabilityModifier: 1.35, chargeRateModifier: 0.6, chargeWindowModifier: 1.4, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'arbor-mh1', name: 'Arbor MH1', maxPower: 1890, resistModifier: 1.25, size: 1, moduleSlots: 1, instabilityModifier: 0.65, chargeWindowModifier: 1.4, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'arbor-mh2', name: 'Arbor MH2', maxPower: 2400, resistModifier: 1.25, size: 2, moduleSlots: 2, instabilityModifier: 0.65, chargeWindowModifier: 1.4, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'helix-1', name: 'Helix I', maxPower: 3150, resistModifier: 0.7, size: 1, moduleSlots: 2, chargeWindowModifier: 0.6, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'helix-2', name: 'Helix II', maxPower: 4080, resistModifier: 0.7, size: 2, moduleSlots: 3, chargeWindowModifier: 0.6, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'hofstede-s1', name: 'Hofstede-S1', maxPower: 2100, resistModifier: 0.7, size: 1, moduleSlots: 1, instabilityModifier: 1.1, chargeRateModifier: 1.2, chargeWindowModifier: 1.6, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'hofstede-s2', name: 'Hofstede-S2', maxPower: 3360, resistModifier: 0.7, size: 2, moduleSlots: 2, instabilityModifier: 1.1, chargeRateModifier: 1.2, chargeWindowModifier: 1.6, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'impact-1', name: 'Impact I', maxPower: 2100, resistModifier: 1.1, size: 1, moduleSlots: 2, instabilityModifier: 0.9, chargeRateModifier: 0.6, chargeWindowModifier: 1.2, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'impact-2', name: 'Impact II', maxPower: 3360, resistModifier: 1.1, size: 2, moduleSlots: 3, instabilityModifier: 0.9, chargeRateModifier: 0.6, chargeWindowModifier: 1.2, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'klein-s1', name: 'Klein-S1', maxPower: 2220, resistModifier: 0.55, size: 1, moduleSlots: 0, instabilityModifier: 1.35, chargeWindowModifier: 1.2, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'klein-s2', name: 'Klein-S2', maxPower: 3600, resistModifier: 0.55, size: 2, moduleSlots: 1, instabilityModifier: 1.35, chargeWindowModifier: 1.2, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'lancet-mh1', name: 'Lancet MH1', maxPower: 2520, resistModifier: 1.0, size: 1, moduleSlots: 1, instabilityModifier: 0.9, chargeRateModifier: 1.4, chargeWindowModifier: 0.4, inertMaterialsModifier: 0.7, optimalDistanceMin: 0, optimalDistanceMax: 0 },
  { id: 'lancet-mh2', name: 'Lancet MH2', maxPower: 3600, resistModifier: 1.0, size: 2, moduleSlots: 2, instabilityModifier: 0.9, chargeRateModifier: 1.4, chargeWindowModifier: 0.4, inertMaterialsModifier: 0.6, optimalDistanceMin: 0, optimalDistanceMax: 0 },
];
